def busca_sequencial (lista,val):
    ...
    procurando por val.
    Se val for encontrado, retorna a posição de podição de val ma lista.
...
# Lista de números para fazer testes de buscas sequencial 
...
for v in vals_busca:
    ...
    if pos >= 0:
        print(f"Elemento {v} encintrado na posição {pos}.")
    else: 
        print(f"Elementos {v} não foi encontrado, pois a busca retornou o valor {pos}.")
print ("-" * 80)
