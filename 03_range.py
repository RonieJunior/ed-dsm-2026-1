...
série (faixa) de número. É muito usada em associação 
com listas e com a instrução "for".
"""
# 1) range() com UM parâmetro 
#   Gera uma sequência numéria que SEMPRE começa 
...
<<<<<<< HEAD
#   1º parâmetro: valor inicial da sequêcia (inclusive)
#   2º parâmetro: valor final da sequência (Exclusive)
#   3º parâmetro: intervalo entre um número gerado e o seguinte (passo)
